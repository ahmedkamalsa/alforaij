...
AREA_TO_GOVERNORATE: dict[str, str] = {
    ...
    "ميناء عبدالله": "الأحمدي", "هدية": "الأحمدي", "الخيران": "الأحمدي",
    "صباح الأحمد": "الأحمدي", "صباح الاحمد": "الأحمدي", "Sabah Al-Ahmad": "الأحمدي",
    ...
    "صباح الأحمد البحرية (الخيران)": "الأحمدي",
...
def normalize_dashboard_place(
    ...
    *,
    ...
    if not area or area in GOVERNORATE_ALIASES:
        hint = " ".join(
